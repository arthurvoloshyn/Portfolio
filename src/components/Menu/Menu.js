...
class Menu extends Component {
  ...
  render() {
    ...
    const effectStyle = this.styleClasses[page] || 'effects-normal';
    const styleStroke = this.styleStroke[page] || 'stroke-normal';
    const styleMenu = this.styleMenu[page] || 'menu-normal';
