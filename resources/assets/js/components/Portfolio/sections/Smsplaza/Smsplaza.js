          ...
          <div className="content content--canvas--smsplaza">
            <div className="smspalza-container">
              ...
              <div className={`info-container tzie-small ${info ? 'd-flex' : 'd-none'}`}>
                ...
                design architecture, development, and code quality control as well. I used Nuxt.js
                as a frontend tool to build the interface. I also used Laravel as a backend
                framework for building the API, Laravel for building administration panel; Vue.js
                for building individual components. I have done complete coverage tests and
